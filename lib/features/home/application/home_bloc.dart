...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  // double initialChildSize = 0.45; //TODO: New Value to //No where used
  double minChildSize = 0.47; //TODO: New Value to 0.49 MG:
  double maxChildSize = 0.99;
  double sheetSize = 0.48; //TODO: New Value to 0.50 MG:
  double midChildSize = 0.67; //TODO: New Value to 0.68 MG:
                  ...
                  if (dist > 100) {
                    animationController = AnimationController(
                      duration: const Duration(
                          //TODO: Change to 1500 as per new MG:
...
//  Locations
        ...
        if (event.isFromHomePage) {
          ...
          if (position != null) {
            ...
            Position position = await Geolocator.getCurrentPosition(
                desiredAccuracy:
                    LocationAccuracy.high); // TODO: UselocationSettings MG:
            double lat = position.latitude;
            double long = position.longitude;
            if (event.isFromHomePage) {
              emit(HomeLoadingStartState());
  ...
  FutureOr<void> getAutoCompleteSearchPlaces(
    ...
    if (event.searchText.length >= 4) {
      ...
      // In New [Start] // TODO: Uncomment MG:
      ...
      if (matchingCachedPlaces.isNotEmpty && mapType == 'google_map') {
        ...
        data.fold(
          ...
          (success) async {
            ...
            //From here emit(SearchOnChangeState()); MG:
          },
        );
        // TO Here MG:
        emit(SearchOnChangeState());
...
// In Old [Start] Commented
    // currentLocation = event.address.address;
// In Old [End] Commented
...
// In New [End]
// In Old [Start] both Below are commented
...
// In Old [End]
  ...
  Future<void> confirmRideAddress(
    ...
    // In Old [Start] Below is Removed in New
