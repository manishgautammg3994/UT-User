          ...
          children: [
                ...
                : fm.FlutterMap(
                    ...
                    options: fm.MapOptions(
                      onTap: (tapPosition, latLng) {
                        ...
                        context.read<HomeBloc>().add(UpdateLocationEvent(
                            isFromHomePage: true,
                            latLng: context.read<HomeBloc>().currentLatLng,
                            // In Old [Start] replacement exists
                    ...
                    children: [
                      fm.TileLayer(
                        ...
                        // In Old [Start] nothing such exists in New
                        ...
                        userAgentPackageName:
                            'com.example.app', // TODO: No Need to Change // MG:
                      ),
                    ],
                  ),
            Positioned(
            ...
            if (context.read<HomeBloc>().confirmPinAddress)
              ...
              Positioned(
                ...
                child: Container(
                  // In Old [Start] replacement exists value change
                    ...
                    children: [
                      ...
                      CustomButton(
                          ...
                          buttonName: AppLocalizations.of(context)!
                              .confirm), // In New [End]
                      // In Old [Start] replacement exists with above stated change
                      // Container(
