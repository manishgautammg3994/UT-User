        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                  height: size.width *
                      0.01), // MG: old 0.025 In New Value change dto 0.01
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  // In Old [Start] replacement exist in new
                    ...
                    children: [
                                ...
                                children: [
                                  fm.TileLayer(
                                    ...
                                    userAgentPackageName:
                                        'com.example.app', //MG: If Possible Package Name
                                  ),
                                  fm.MarkerLayer(
                                    markers: context
                                        .read<HomeBloc>()
                      ...
                      if (context.read<HomeBloc>().confirmPinAddress)
                        ...
                        Positioned(
                          top: screenWidth * 0.1,
                          right: screenWidth *
                              0.38, // MG: Uncommented this as per New
                          child: Container(
                            height: size.height * 0.8,
                            width: size.width,
                            alignment: Alignment.center,
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Container(
                            ...
                            child: SingleChildScrollView(
                              physics: const NeverScrollableScrollPhysics(),
                              child:
                                  // bottomSheetBuilder(size, context), // MG: Replacement code NEW
                                  context.read<HomeBloc>().serviceAvailable
